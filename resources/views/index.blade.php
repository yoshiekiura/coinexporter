...
<div class="icon-layer-one"><img src="images/icon-1.png" alt=""/></div>
<div class="icon-layer-three"><img src="images/pattern-1.png" alt=""/></div>
<div class="icon-layer-two"><img src="images/icon-1.png" alt=""/></div>
	...
	<div class="container-fluid p-0">
		<div class="row align-items-center">
			...
			<div class="col-md-6 p-0">
				<div class="ce-img">
					<img src="images/exportbg.jpg" alt="">
				</div>
			</div>
		</div>
	</div>
