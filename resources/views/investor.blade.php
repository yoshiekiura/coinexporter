      ...
      <div class="row align-items-center">
        ...
        <div class="col-lg-7 col-sm-7">
          <div class="benifit-txt">
            <p class="text text-justify"> Investors who hold $COINEXPT, the CoinExporter native token will have opportunity to participate in the variety of the staking pools available to them and based on their interest. There are going to different staking pools of two categories: staking $COINEXPT and get $COINEXPT, while the other category is to stake $COINEXPT and get other valuable and amazing $COINS or $TOKENS from other projects who partner with CoinExporter.
                <br><br>
