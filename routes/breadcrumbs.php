...
// Home > UserPromotor
Breadcrumbs::for('userpromotors.index', function ($trail) {
    $trail->parent('dashboard');
    $trail->push(__('userpromotor.breadcrumb.index'), route('userpromotors.index'));
});

Breadcrumbs::for('userpromotors.create', function ($trail) {
    $trail->parent('userpromotors.index');
    $trail->push(__('userpromotor.breadcrumb.create'), route('userpromotors.create'));
});

Breadcrumbs::for('userpromotors.edit', function ($trail) {
    $trail->parent('userpromotors.index');
    $trail->push(__('userpromotor.breadcrumb.edit'), route('userpromotors.edit', '$userpromotor->id'));
});
// Home > File Manager
