...
class JobdetailController extends Controller
{
    ...
    public function index($id)
    {
        ...
        return view('jobdetail', compact('jobSpaceData'));
...
//dd($dataJobDone);
    ...
    if ($dataJobDone->save()) {
        ...
        // $jobdone = JobDone::first();
        // $jobsDone = $jobdone->id;
        // if($jobsDone >= 1){
        //     return redirect()->route('jobdetail', ['id' => $request->campainId])->with('error', 'You have already done this campaign task!');
        // }else{
